          ...
          <div class="p-6">
            <div class="space-y-4 max-w-md">
              <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                  <label class="block text-xs font-medium text-base-content/60 mb-1.5">Port</label>
                  <input
                    type="number"
              ...
              <div>
                <label class="block text-xs font-medium text-base-content/60 mb-1.5">Username</label>
                <input
                  type="text"
              ...
              <div class="grid grid-cols-2 gap-4">
                <div>
                  <label class="block text-xs font-medium text-base-content/60 mb-1.5">
                    From Name <span class="text-base-content/40">(optional)</span>
                  </label>
                  <input
                    type="text"
          ...
          <div class="px-6 py-3 bg-base-100 border-t border-base-300 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              <button
                ...
                class="px-4 py-1.5 text-sm text-base-content/80 border border-base-content/20 rounded-md hover:bg-base-300 transition-colors font-medium"
              >
                Send Test
              </button>
              <button
